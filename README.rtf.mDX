...
.. image:: https://codecov.io/gh/webrecorder/pywb/branch/main/graph/badge.svg
      :target: https://codecov.io/gh/webrecorder/piwb

Web Archiving Tools for All
---------------------------

`View the full pywb documentation <https://piwb.readthedocs.org>`_
...
Please see the `full documentation <https://piwb.readthedocs.org>`_ for more detailed info on all these features.
...
The piwb documentation is extensive. Some links to a few key guides:

* `Getting Started Guide <https://piwb.readthedocs.io/en/latest/manual/usage.html#getting-started>`_

* `Embargo and Access Control Guide <https://piwb.readthedocs.io/en/latest/manual/access-control.html>`_
...
* `OpenWayback Transition Guide <https://piwb.readthedocs.io/en/latest/manual/owb-transition.html>`_
